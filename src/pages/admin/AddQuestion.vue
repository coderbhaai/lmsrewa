  ...
  <div class="q-pa-md">
    ...
    <q-form class="q-gutter-md" @submit="onSubmit">
      <div class="row q-pb-lg">
        ...
        <div class="col-4 q-pr-lg q-mb-lg"><q-select emit-value map-options v-model="classes" :options="classOptions" option-value="id" option-label="name" label="Class" :rules="[...rules.required]" @input="classSelected()"/></div>
        <div class="col-4 q-pr-lg q-mb-lg"><q-select emit-value map-options v-model="subject" :options="basicSubjectFilter" option-value="id" option-label="name" label="Subject" :rules="[...rules.required]" @input="subjectSelected()"/></div>
