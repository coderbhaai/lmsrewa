        ...
        <section class="points mb-5">
            <div class="container page py-3">
                ...
                <q-form class="q-gutter-md" @submit="onSubmit" v-if="this.showFilter" >
                    <div class="row">
                        <div class="col-4 q-pr-lg q-mb-lg"><q-select emit-value map-options v-model="type" :options="typeOptions" option-value="id" option-label="name" label="Type" lazy-rules required/></div>
                        ...
                        <div class="col-4 q-pr-lg q-mb-lg"><q-select emit-value map-options v-model="board" :options="boardOptions" option-value="id" option-label="name" label="Board" lazy-rules required/></div>
                        ...
                        <div class="col-4 q-pr-lg q-mb-lg"><q-select multiple emit-value map-options v-model="topic" :options="basicTopicFilter" option-value="id" option-label="name" label="Topic" lazy-rules required @input="topicSelected()"/></div>
                        <div class="col-sm-8 q-pr-lg q-mb-lg"><q-select multiple map-options emit-value v-model="subTopic" :options="testSubTopicFilter" option-value="id" option-label="name" label="SubTopic" lazy-rules required @input="subTopicSelected()"/></div>
                    </div>
